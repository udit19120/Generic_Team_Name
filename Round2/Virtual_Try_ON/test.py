...
def get_opt():
    ...
    parser.add_argument("--dataroot", default="./custom")
    ...
    parser.add_argument('--result_dir', type=str,
                        default='./custom/test', help='save result infos')

    parser.add_argument('--checkpoint', type=str, default='./CP-VTON+/checkpoints/TOM/tom_final.pth')
